...
//		assertEquals(1, effectedNum);
	...
	public void testBQueryShopAuth() throws Exception {
		...
		List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthMapListByShopId(93, 0, 2);
...
//		assertEquals(1, count);
	...
	public void testCUpdateShopAuthMap() throws Exception {
		List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthMapListByShopId(93, 0, 1);
	...
	public void testDeleteShopAuthMap() throws Exception {
		List<ShopAuthMap> shopAuthMapList1 = shopAuthMapDao.queryShopAuthMapListByShopId(93, 0, 1);
		List<ShopAuthMap> shopAuthMapList2 = shopAuthMapDao.queryShopAuthMapListByShopId(94, 0, 1);
