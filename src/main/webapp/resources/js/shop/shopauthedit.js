$(function() {
	...
	// 根据主键获取授权信息的URL
	var infoUrl = '/student/shopadmin/getshopauthmapbyid?shopAuthId=' + shopAuthId;
	// 修改授权信息的URL
	var shopAuthPostUrl = '/student/shopadmin/modifyshopauthmap';
	...
	if (shopAuthId) {
		...
		$.toast('用户不存在！');
		window.location.href = '/student/shopadmin/shopmanage';
	}
