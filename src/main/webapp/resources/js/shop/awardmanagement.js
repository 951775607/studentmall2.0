$(function() {
	// 获取该店铺下的奖品列表URL
	var listUrl = '/student/shopadmin/listawardsbyshop?pageIndex=1&pageSize=9999';
	// 设置奖品的可见状态
	var changeUrl = '/student/shopadmin/modifyaward';
	getList();
	function getList() {
		// 访问后台，获取奖品列表
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/student/shopadmin/awardoperation?awardId='
							...
							window.location.href = '/student/frontend/awarddetail?awardId='
									+ e.currentTarget.dataset.id;
						}
					});
