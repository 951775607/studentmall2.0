$(function () {
    // 列出该店铺下所有授权信息的URL
    var listUrl = '/student/shopadmin/listshopauthmapsbyshop?pageIndex=1&pageSize=9999';
    // 修改授权信息的URL
    var modifyUrl = '/student/shopadmin/modifyshopauthmap';
    getList();
    qrious();
        ...
        .on('click', 'a',
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    window.location.href = '/student/shopadmin/shopauthedit?shopAuthId='
    ...
    function qrious() {
        $.ajax({
            url : "/student/shopadmin/generateqrcode4shopauth",
            type : "get",
            dataType : "json",
            success : function(data) {
                if (data.success) {
