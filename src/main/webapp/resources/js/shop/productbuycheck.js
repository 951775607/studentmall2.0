$(function() {
	...
	function getList() {
		// 获取用户购买信息的URL
		var listUrl = '/student/shopadmin/listuserproductmapsbyshop?pageIndex=1&pageSize=9999&productName='
				+ productName;
		// 访问后台，获取该店铺的购买信息列表
	...
	function getProductSellDailyList() {
		// 获取该店铺商品7天销量的URL
		var listProductSellDailyUrl = '/student/shopadmin/listproductselldailyinfobyshop';
		// 访问后台，该店铺商品7天销量的URL
    ...
    //         	name:'ss',
	// 			type:'bar',
	// 			data:[120,132,125,303,545,320,145]
	// 		},{
    //             name:'ff',
    //             type:'bar',
    //             data:[120,132,125,303,545,320,145]
