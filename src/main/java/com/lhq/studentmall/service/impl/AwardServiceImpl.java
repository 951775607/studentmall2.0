...
import com.lhq.studentmall.dao.AwardDao;
import com.lhq.studentmall.dto.AwardExecution;
import com.lhq.studentmall.dto.ImageHolder;
import com.lhq.studentmall.entity.Award;
import com.lhq.studentmall.enume.AwardStateEnum;
		...
		if (award != null && award.getAwardId() != null) {
			...
			if (thumbnail != null) {
				...
				if (tempAward.getAwardImg() != null) {
					ImgeUtil.deleteFileOrPath(tempAward.getAwardImg());
				}
				// 存储图片流，获取相对路径
				addThumbnail(award, thumbnail);
			}
