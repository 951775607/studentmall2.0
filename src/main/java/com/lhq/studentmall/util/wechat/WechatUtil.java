package com.lhq.studentmall.util.wechat;
...
public class WechatUtil {
	...
	public static UserAccessToken getUserAccessToken(String code) throws IOException {
		// 测试号信息里的appId
		String appId = "wxa33c7fae45eac655";
		log.debug("appId:" + appId);
		// 测试号信息里的appsecret
		String appsecret = "dd06e5616c9c5a141b08d378a0e8499a";
	...
	/**
	 * 功能描述:将WhatUser里的信息转换成PersonInfo信息并返回PersonInfo实体类
	 *
	 * @param:
	 * @return:
	 **/
