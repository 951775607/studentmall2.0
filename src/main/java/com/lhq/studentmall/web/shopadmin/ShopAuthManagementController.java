...
import com.lhq.studentmall.service.ShopAuthMapService;
...
public class ShopAuthManagementController {
	...
	private Map<String, Object> listShopAuthMapsByShop(HttpServletRequest request) {
		...
		if ((pageIndex > -1) && (pageSize > -1) && (currentShop != null) && (currentShop.getShopId() != null)) {
			...
			modelMap.put("errMsg", "分页信息或店铺信息为空！");
		}
		return modelMap;
	}
...
//				String longUrl = urlPrefix + authUrl + urlMiddle + shopId + urlSuffix;
				modelMap.put("success", true);
...
//			String qrCodeinfo = request.getParameter("state");

//			long number = Long.parseLong(qrCodeinfo);
			ObjectMapper mapper = new ObjectMapper();
