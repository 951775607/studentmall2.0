package com.lhq.studentmall.web.wechat;
...
public class WeChatLoginController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		//获取微信公众号传输过来的code，通过code可获取access_token
		String code = request.getParameter("code");
		//用来传自定义信息，方便程序调用的，可以不用
...
//			return null;
//		}
		//获取到openid后，可以通过它去数据库判断微信账号是否在我们的网站里有对应的账号，没有的话自动创建，有的话与网站对接
		if (auth == null) {
			//如果账号信息不存在则创建账号
